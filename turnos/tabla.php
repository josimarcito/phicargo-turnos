...
$cn = conectar();
$sqlSelect = "SELECT ID_TURNO, TURNO, ID_OPERADOR, TURNOS.ID_UNIDAD, ECO, NOMBRE_OPERADOR, FECHA_LLEGADA, HORA_LLEGADA, COMENTARIOS FROM TURNOS LEFT JOIN OPERADORES ON TURNOS.ID_OPERADOR = OPERADORES.ID INNER JOIN UNIDADES ON TURNOS.ID_UNIDAD = UNIDADES.ID_UNIDAD  WHERE FECHA_LLEGADA BETWEEN '2022-12-01' AND '2022-12-01' AND HORA_LLEGADA BETWEEN '09:00' AND '21:00' ORDER BY HORA_LLEGADA ASC";
